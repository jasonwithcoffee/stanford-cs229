\item \subquestionpointswritten{5} {\bf Learning degree-3 polynomials of the input}
...
\begin{flalign*}
    ...
    &= \frac{1}{2} \sum_{i=1}^{\nexp} \left( h_{\theta}(\hat{x}^{(i)}) - y^{(i)} \right)^2 
    & 
    & & & & & &\\[50pt]
\end{flalign*}
