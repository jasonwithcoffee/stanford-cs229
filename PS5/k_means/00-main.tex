\item \points{7} {\bf K-means for compression}
...
that, for each of the $512\times 512 = 262,144$ pixels in the image, there are three
...
representation of this image therefore takes about $262,144 \times 3 =
786,432$ bytes (a byte being 8 bits). To compress the image, we will
