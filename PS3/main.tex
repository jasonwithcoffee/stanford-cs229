\def\due{Monday, 24 August 2020}
\def\zipscript{(There is no zip submission for this problem set.)}
\def\zipscriptalt{(There is no zip submission for this problem set.)}
\def\psetnum{3 }
...
% LINES IMMEDIATELY PRECEDING THIS STATEMENT IS EXACTLY AS FOLLOWS:                       %
%                                                                                         %
%      \ifdefined\solutions {2} \else \def\solutions{1} \fi                               %
%                                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
